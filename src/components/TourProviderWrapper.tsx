    ...
    },
    {
        ...
        content: ({ setIsOpen }: any) => (
            <TourContent
                setIsOpen={setIsOpen}
                title="פרופיל אישי"
                content="כאן נמצא הפרופיל האישי שלך. דבר ראשון הקלד את השם בו תופיע לשאר המשתמשים במערכת. משם גם תוכל לבקש להצטרף לאחת הקבוצות הקיימות."
            />
        ),
    },
    {
        selector: '[data-tour="groups-nav"]',
        content: ({ setIsOpen }: any) => (
            <TourContent
                setIsOpen={setIsOpen}
                title="קבוצות"
                content="הכל מתחיל בקבוצה. בכדי להשתמש במערכת עליכם להשתייך לפחות לקבוצה אחת (בדומה לקבוצת וואצאפ). המחסנים, הפעילויות והכשירויות שלכם יהיו מקושרים לקבוצה שלכם כך שרק אתם תוכלו לצפות בהם. מנהלי קבוצה יכולים לאשר הרשאה למשתמשים חדשים ולקדם אותם למנהלים בעצמם."
            />
        ),
    },
    {
    ...
    },
    {
        ...
        content: ({ setIsOpen }: any) => (
            <TourContent
                ...
                isFinalStep={true}
                title="יוצאים לדרך!"
                content={`וזהו, אתם מוכנים להשתמש במערכת Ordo! \n\nצאו לגלות את כל הפיצ'רים הנוספים שלא דיברנו עליהם והכי חשוב, אם יש לכם רעיונות לשיפור או סתם משוב תוכלו לכתוב הודעה ונשפר את המערכת בהקדם, בהבטחה!\n\nאז יאללה צאו ליצור את הקבוצה החדשה שלכם או הצטרפו לקבוצה קיימת.`}
            />
        ),
    }
];
